...
import static com.unilead.Mraids.isStorePictureSupported;
...
public class AdUrlGenerator extends BaseUrlGenerator {
    ...
    /**
     * Equivalent to TYPE_DUMMY introduced in API level 14. Will generate the "unknown" code
     */
    public static final int UNKNOWN_NETWORK_TYPE = 0x00000008;
    ...
    public String generateUrlString(String serverHostname) {
        initUrlString(serverHostname, UnileadView.AD_HANDLER);

        setApiVersion("6");

        setAdUnitId(mAdUnitId);

        setSdkVersion(Utils.SDK_VERSION);
