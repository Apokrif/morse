...
import com.unilead.CustomEventBanner.CustomEventBannerListener;
...
public class CustomEventBannerAdapter implements CustomEventBannerListener {
    ...
    private UnileadView mMoPubView;
    ...
    public CustomEventBannerAdapter(UnileadView moPubView, String className, String classData) {
        ...
        try {
            mCustomEventBanner = CustomEventBanner.Factory.create(className);
        } catch (Exception exception) {
            Log.d("MoPub", "Couldn't locate or instantiate custom event: " + className + ".");
            mMoPubView.loadFailUrl(ErrorCode.ADAPTER_NOT_FOUND);
            return;
        }
        ...
        if (mMoPubView.getAdViewController() != null) {
            mLocalExtras.put(AdFetcher.AD_CONFIGURATION_KEY, mMoPubView.getAdViewController().getAdConfiguration());
        }
    }
    ...
    public static class Factory {
        ...
        public static CustomEventBannerAdapter create(UnileadView moPubView, String className, String classData) {
            return instance.internalCreate(moPubView, className, classData);
        }

        protected CustomEventBannerAdapter internalCreate(UnileadView moPubView, String className, String classData) {
