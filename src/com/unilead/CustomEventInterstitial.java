 ...
 * demand.
 * 
 * At runtime, the SDK will find and instantiate a CustomEventInterstitial subclass as needed
 * and invoke its loadInterstitial() method.
 */
public abstract class CustomEventInterstitial {
    
    /*
     * When the SDK receives a response indicating it should load a custom event, it will send
     ...
     * It must also notify the provided CustomEventInterstitial.Listener Object of certain life cycle
     * events.
     * 
     ...
     * AdNetwork web site that you want to associate with a given custom event request. This data may be
